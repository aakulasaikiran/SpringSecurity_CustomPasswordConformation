...
public class CustomerController {
	 ...
	 * model.setViewName("custSave"); return model; }
	 */
	 ...
	 * (bindingResult.hasErrors()) { logger.info("Returning custSave.jsp page");
	 * model.setViewName("custSave"); return model; }
	 * model.addObject("customer", customer); customers.put(customer.getId(),
	 * customer); model.setViewName("custSaveSuccess"); return model;
	 * 
	 * }
	 */
